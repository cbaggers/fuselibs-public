...
namespace Fuse.Scripting.ReactNative
{
	...
	public class ReactNativeContext : Fuse.Scripting.JavaScriptCore.Context
	{
		...
		class ASyncInitBuiltinsBox
		{
			...
			{
				var context = (ReactNativeContext)ctx;
				context.Init(context._context);
		...
		internal void InvokeOnJSThread(Func<Fuse.Scripting.JavaScript.JSContext, bool> action, Action<string> exceptionCallback)
		@{
